...
const ADMIN_NAV = [
  ...
  { label: 'Subject Analytics',  icon: <I.Explorer />,   to: '/analytics/subjects'    },
  { label: 'Student Analytics',  icon: <I.Explorer />,   to: '/student-analytics'     },
  { label: 'Predictive Reports', icon: <I.Predictor />,  to: '/predictions'           },
...
export default function Sidebar() {
  ...
  const navItems = isAdmin ? ADMIN_NAV : LECTURER_NAV;
