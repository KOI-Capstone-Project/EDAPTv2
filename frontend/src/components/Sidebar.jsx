...
const ADMIN_NAV = [
  { label: 'Data Ingestion', icon: <IconIngestion />, to: '/data-ingestion', adminOnly: true },
  { label: 'Audit Log',      icon: <IconAuditLog />,  to: '/audit-log',      adminOnly: true },
  { label: 'AI Engine',      icon: <IconAIEngine />,  to: '/ai-engine',      adminOnly: true },
