...
function RiskBadge({ level }) {
  ...
  return (
    <span style={{ ...s.badge, background: c.bg, color: c.color }}>{level}</span>
  );
}
  ...
  return (
    <svg width={140} height={80} viewBox="0 0 140 80">
      <path
        ...
        fill="none" stroke="#EEF0F4" strokeWidth={stroke} strokeLinecap="round"
      />
      <path
        d={`M ${cx - r} ${cy} A ${r} ${r} 0 0 1 ${cx + r} ${cy}`}
            ...
            <div style={s.resultCard}>
              ...
              <div style={s.gaugeRow}>
                ...
                <div style={s.predictionLabel}>
                  ...
                  <p style={s.confText}>
                    Based on {result.confidence_records} similar records
                  </p>
                </div>
              </div>
...
const s = {
  ...
  modelTag: {
    ...
    background: '#fff', border: '0.5px solid #DDE4EA', borderRadius: 10, padding: '8px 14px',
  },
  ...
  infoCard: {
    background: '#F8FAFC', border: '0.5px solid #DDE4EA', borderRadius: 10, padding: '14px 16px',
  },
  ...
  resultCard: {
    background: '#fff', border: '0.5px solid #DDE4EA', borderRadius: 10, padding: '24px',
  },
